...
class AdminController extends Controller
{
    ...
    public function update_order_status(Request $request)
    {
        ...
        return back()->with("status","Status alterado com sucesso!");
    }
    ...
    public function slide_store(Request $request)
    {
        ...
        $slide->save();
        return redirect()->route('admin.slides')->with("status","Controle deslizante adicionado com sucesso");
    }
    ...
    public function slide_update(Request $request)
    {
        ...
        $slide->save();
        return redirect()->route('admin.slides')->with("status","Controle deslizante editado com sucesso");
    }
