        ...
        <div class="tab-pane fade show active" id="tab-item-login" role="tabpanel" aria-labelledby="login-tab">
          <div class="login-form">
            <form method="POST" action="{{route('login')}}" name="login-form" class="needs-validation" novalidate="">
              ...
              <button class="btn btn-primary w-100 text-uppercase" type="submit">Conecte-se</button>

              <div class="customer-option mt-4 text-center">
                <span class="text-secondary">Ainda não tem conta?</span>
                <a href="{{route('register')}}" class="btn-text js-show-register">Criar uma conta</a>
              </div>
            </form>
          </div>
        </div>
