        ...
        <div class="col-lg-5">
          <div class="d-flex justify-content-between mb-4 pb-md-2">
            <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
              ...
              <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">Produtos</a>
            </div><!-- /.breadcrumb -->
            ...
            <div
              ...
              <a href="#" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Próximo</span><svg
          ...
          @if (Cart::instance('cart')->content()->where('id',$product->id)->count()>0)
              <a href="{{route('cart.index')}}" class="btn btn-warning mb-3">Vá para o carrinho</a>
          @else
          ...
          <div class="product-single__addtolinks">
            ...
            <form method="POST" action="{{route('wishlist.item.remove',['rowId'=>Cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId])}}" id="frm-remove-item">
                ...
                <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('frm-remove-item').submit();"><svg width="16" height="16" viewBox="0 0 20 20"
                    ...
                    <use href="#icon_heart" />
                </svg><span>Remover da lista de desejos</span></a>
            </form>
            @else
            <form method="POST" action="{{route('wishlist.add')}}" id="wishlist-form">
                ...
                <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist" onclick="document.getElementById('wishlist-form').submit();"><svg width="16" height="16" viewBox="0 0 20 20"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_heart" />
                </svg><span>Adicionar a lista de desejos</span></a>
            </form>
            @endif
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="tab-additional-info" role="tabpanel" aria-labelledby="tab-additional-info-tab">
            <div class="product-single__addtional-info">
              ...
              <div class="item">
                <label class="h6">Dimensões</label>
              ...
              <div class="item">
                <label class="h6">Cor</label>
                <span>Preto, Laranja, Branco</span>
              </div>
              <div class="item">
                <label class="h6">Estilo</label>
                <span>Vestido estilo camisa de corte descontraído com acabamento robusto</span>
              </div>
            </div>
          </div>
          <div class="tab-pane fade" id="tab-reviews" role="tabpanel" aria-labelledby="tab-reviews-tab">
            ...
            <div class="product-single__reviews-list">
              <div class="product-single__reviews-item">
                ...
                <div class="customer-review">
                  ...
                  <div class="review-date">06 de abril de 2023</div>
            ...
            <div class="product-single__review-form">
              <form name="customer-review-form">
                <h5>Seja o primeiro a avaliar “T-Shirt de algodão Message”</h5>
                ...
                <div class="mb-4">
                  <textarea id="form-input-review" class="form-control form-control_gray" placeholder="Sua avaliação"
                    cols="30" rows="8"></textarea>
                </div>
                <div class="form-label-fixed mb-4">
                  <label for="form-input-name" class="form-label">Nome *</label>
