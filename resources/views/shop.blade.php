            ...
            <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
              ...
              <div class="accordion-body px-0 pb-0 pt-3">
                <ul class="list list-inline mb-0">
                  ...
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Moletons</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Trajes de banho</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Jaquetas</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Camisetas e Tops</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Jeans</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Calça</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Homem</a>
                  </li>
                  <li class="list-item">
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <div class="price-range__info d-flex align-items-center mt-2">
                <div class="me-auto">
                  <span class="text-secondary">Menor preço: </span>
                  <span class="price-range__min">R$ 250,00</span>
                </div>
                <div>
                  <span class="text-secondary">Maior preço: </span>
                  <span class="price-range__max">R$ 450,00</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="shop-list flex-grow-1">
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Mulheres <br /><strong>ACCESSÓRIOS</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Acessórios são a melhor maneira de
                        atualize seu visual. Adicione uma borda de título com novos estilos e novas cores ou opte por peças atemporais.</h6>
                  </div>
                </div>
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
            ...
            <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">Loja</a>
          </div>
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items"
              name="total-number">
              <option selected>Classificação padrão</option>
              <option value="1">Faturamento</option>
              <option value="2">Os mais vendidos</option>
              <option value="3">Alfabeto, A-Z</option>
              <option value="3">Alfabeto, Z-A</option>
              <option value="3">Preço, baixo a alto</option>
              <option value="3">Preço, alto a baixo</option>
              <option value="3">Data, antigo para novo</option>
              <option value="3">Data, do novo ao antigo</option>
            </select>

            <div class="shop-asc__seprator mx-3 bg-light d-none d-md-block order-md-0"></div>

            <div class="col-size align-items-center order-1 d-none d-lg-flex">
              <span class="text-uppercase fw-medium me-2">Visualizar</span>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                ...
                @if (Cart::instance('cart')->content()->where('id',$product->id)->count()>0)
                    <a href="{{route('cart.index')}}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning mb-3">Vá para o carrinho</a>
                @else
                <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                    ...
                    <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" data-aside="cartDrawer" title="Adicionar ao carrinho">Adicionar ao carrinho</button>
                </form>
                @endif
              </div>
              ...
              <div class="pc__info position-relative">
                ...
                <div class="product-card__price d-flex">
                  <span class="money price">
                    @if ($product->sale_price)
                        <s>R$ {{$product->regular_price}} </s> R${{$product->sale_price}}
                    @else
                ...
                <div class="product-card__review d-flex align-items-center">
                  ...
                  <span class="reviews-note text-lowercase text-secondary ms-1">Mais de 8 mil avaliações</span>
                </div>
        ...
        <div class="flex items-center justify-between flex-wrap wg-pagination">
